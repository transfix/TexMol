...
int Octree::min_vtx_tetra(int x, int y, int z, int e_id_0, int e_id, int level, int& con_ind, int& con_ind_1, Geoframe& geofrm)
{
	...
	if((minmax[oc_id].max <= iso_val && (meshType == TRI || meshType == TET || meshType == QUAD || meshType == HEX)) ||
			(minmax[oc_id].max <= iso_val && minmax[oc_id].min >= iso_val_in && (meshType == TRI2 || meshType == TET2) ))
	{
...
void Octree::face_3(int x, int y, int z, int face_id, int cell_size, int v0, int v1, int v2, int v3, int v4, unsigned int* array0, unsigned int* array1, unsigned int* array2, int m_id0, int m_id1, int m_id2, Geoframe& geofrm)
{
	int t, tt;
...
void Octree::get_middle_array_1(int face_id, int* my_edge0, int* my_edge1, int* my_edge2, int* my_edge3, unsigned int* my_array, int& m_id, int x, int y, int z, int level, Geoframe& geofrm)
{
...
void Octree::get_middle_array_2(int face_id, int* my_edge0, int* my_edge1, int* my_edge2, int* my_edge3, unsigned int* my_array0, unsigned int* my_array1, int& m_id0, int& m_id1, int x, int y, int z, int level, Geoframe& geofrm)
{
...
void Octree::get_middle_array_3(int face_id, int* my_edge0, int* my_edge1, int* my_edge2, int* my_edge3, unsigned int* my_array0, unsigned int* my_array1, unsigned int* my_array2, int& m_id0, int& m_id1, int& m_id2, int x, int y, int z, int level, Geoframe& geofrm)
{
