...
PDBParser::GroupOfAtoms* XYZRFile::loadFile(const string& fileName, bool deleteWater)
{
...
bool XYZRFile::checkType(const string& fileName)
{
	return false;
}

bool XYZRFile::saveFile(PDBParser::GroupOfAtoms* molecule, const string& fileName, unsigned int level, CCVOpenGLMath::Matrix* transformation)
{
