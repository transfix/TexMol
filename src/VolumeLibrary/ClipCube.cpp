...
#include <VolumeLibrary/LookupTables.h>
...
ClipCube::ClipCube(double ratioX, double ratioY, double ratioZ, double minX, double minY, double minZ, double maxX, double maxY, double maxZ)
{
