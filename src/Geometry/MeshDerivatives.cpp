...
MeshDerivatives::MeshDerivatives(unsigned int numTris, unsigned int numTriVerts, unsigned int* tris, float* triVerts, float* triVertNormals, float* triMeanCurv, float* triGaussianCurv, float* k1, float* k2)
{
	m_NumTris = numTris;
...
double MeshDerivatives::voronoiArea(unsigned int vertIndex, unsigned int vleft, unsigned int vright, double angleVLeft, double angleVRight)
{
