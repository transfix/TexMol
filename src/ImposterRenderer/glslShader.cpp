...
glslShader::glslShader(const char *vsFile, const char *fsFile) {
    initFromFile(vsFile, fsFile);
}

void glslShader::initFromFile(const char *vsFile, const char *fsFile) {
...
void glslShader::initFromString(const char *vs, const char *fs) {
	shader_vp = glCreateShader(GL_VERTEX_SHADER);
	shader_fp = glCreateShader(GL_FRAGMENT_SHADER);
