...
int within(int tri, double xmin, double xmax, double ymin, double ymax, double zmin, double zmax)
{
	...
	if((isBetween(xmin, xmax, x0)) && (isBetween(ymin, ymax, y0)) && (isBetween(zmin, zmax, z0)))
	{
		return 1;
	}
	if((isBetween(xmin, xmax, x1)) && (isBetween(ymin, ymax, y1)) && (isBetween(zmin, zmax, z1)))
	{
		return 1;
	}
	if((isBetween(xmin, xmax, x2)) && (isBetween(ymin, ymax, y2)) && (isBetween(zmin, zmax, z2)))
	{
		return 1;
	}
