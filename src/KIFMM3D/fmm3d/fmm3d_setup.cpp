...
int FMM3d::setup(map<string,string>& opts)
{
  ...
  switch(_knl.kernelType()) {
	 //laplace kernels
  case KNL_LAP_I: _knl_mm = Kernel3d(KNL_LAP_I, _knl.coefs()); break;
  ...
  case KNL_LAP_DX_U: _knl_mm = Kernel3d(KNL_LAP_S_U, _knl.coefs()); break;
  case KNL_LAP_DY_U: _knl_mm = Kernel3d(KNL_LAP_S_U, _knl.coefs()); break;
  case KNL_LAP_DZ_U: _knl_mm = Kernel3d(KNL_LAP_S_U, _knl.coefs()); break;
  case KNL_LAP_QX_U: _knl_mm = Kernel3d(KNL_LAP_S_U, _knl.coefs()); break;
  case KNL_LAP_QY_U: _knl_mm = Kernel3d(KNL_LAP_S_U, _knl.coefs()); break;
  case KNL_LAP_QZ_U: _knl_mm = Kernel3d(KNL_LAP_S_U, _knl.coefs()); break;
	 //boltzmann kernels
  case KNL_BOZ_S_U: _knl_mm = Kernel3d(KNL_BOZ_S_U, _knl.coefs()); break;
  case KNL_BOZ_D_U: _knl_mm = Kernel3d(KNL_BOZ_S_U, _knl.coefs()); break;
  case KNL_BOZ_DX_U: _knl_mm = Kernel3d(KNL_BOZ_S_U, _knl.coefs()); break;
  case KNL_BOZ_DY_U: _knl_mm = Kernel3d(KNL_BOZ_S_U, _knl.coefs()); break;
  case KNL_BOZ_DZ_U: _knl_mm = Kernel3d(KNL_BOZ_S_U, _knl.coefs()); break;
  case KNL_BOZ_QX_U: _knl_mm = Kernel3d(KNL_BOZ_S_U, _knl.coefs()); break;
  case KNL_BOZ_QY_U: _knl_mm = Kernel3d(KNL_BOZ_S_U, _knl.coefs()); break;
  case KNL_BOZ_QZ_U: _knl_mm = Kernel3d(KNL_BOZ_S_U, _knl.coefs()); break;
    
    // arand: fix these?
    // FIXME: I am not sure what is correct here but it is important...
  case KNL_PBE_11_U: _knl_mm = Kernel3d(KNL_BOZ_S_U, _knl.coefs()); break;
  case KNL_PBE_12_U: _knl_mm = Kernel3d(KNL_PBE_12_U, _knl.coefs()); break; // problem
  case KNL_PBE_21X_U: _knl_mm = Kernel3d(KNL_PBE_21X_U, _knl.coefs()); break; // problem
  case KNL_PBE_21Y_U: _knl_mm = Kernel3d(KNL_PBE_21X_U, _knl.coefs()); break; //problem
  case KNL_PBE_21Z_U: _knl_mm = Kernel3d(KNL_PBE_21X_U, _knl.coefs()); break; // problem
  case KNL_PBE_22X_U: _knl_mm = Kernel3d(KNL_LAP_S_U, _knl.coefs()); break;
  case KNL_PBE_22Y_U: _knl_mm = Kernel3d(KNL_LAP_S_U, _knl.coefs()); break;
  case KNL_PBE_22Z_U: _knl_mm = Kernel3d(KNL_LAP_S_U, _knl.coefs()); break;
