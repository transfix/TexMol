...
void Kernel3d_MPI::homogeneousDeg(vector<double>& degVec) const
{
  ...
  case KNL_LAP_S_U: degVec.resize(1); degVec[0]=1; break;
	 //boltzmann
    //case KNL_BOZ_S_U: degVec.resize(1); degVec[0]=1; break; 
  case KNL_BOZ_S_U: degVec.resize(0); break;
    //case KNL_PBE_11_U: degVec.resize(1); degVec[0]=1; break;
  case KNL_PBE_11_U: degVec.resize(0); break;
  case KNL_PBE_12_U: degVec.resize(1); degVec[0]=0; break;
  case KNL_PBE_21X_U: degVec.resize(0); break;
    //case KNL_PBE_21X_U: degVec.resize(1); degVec[0]=1; break;
