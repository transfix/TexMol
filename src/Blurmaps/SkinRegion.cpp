...
double SkinRegion::signed_dist_pt2sphere(double x_pos,double y_pos,double z_pos,double radius, double c_x, double c_y, double c_z)
{
...
bool SkinRegion::getSkinRegion(PDBParser::GroupOfAtoms* molecule, int dim1, int dim2, int dim3,
