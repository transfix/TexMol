...
Extents::Extents(double xMin, double xMax, double yMin, double yMax, double zMin, double zMax)
{
...
void Extents::setExtents(double xMin, double xMax, double yMin, double yMax, double zMin, double zMax)
{
	m_XMin = xMin;
	m_XMax = xMax;
	m_YMin = yMin;
...
{
	return Vector((float)((m_XMin + m_XMax)/2.0), (float)((m_YMin + m_YMax)/2.0), (float)((m_ZMin + m_ZMax)/2.0), 1.0f);
}
