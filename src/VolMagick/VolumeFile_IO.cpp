...
/* $Id: VolumeFile_IO.cpp 6011 2012-09-11 20:32:35Z edwardsj $ */
...
namespace VolMagick
{
                                     ...
                                     const Dimension& maxdim) const
  {
    ...
    readVolumeFile(vol,filename,var,time,off_x,off_y,off_z,dim,maxdim);
	  ...
	  try
	      ...
	      if(*i)
		{
		  (*i)->readVolumeFile(vol,filename,var,time,
				       off_x,off_y,off_z,subvoldim, maxdim);
		  return;
		}
	    }
