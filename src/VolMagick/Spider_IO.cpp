...
/* $Id: Spider_IO.cpp 6011 2012-09-11 20:32:35Z edwardsj $ */
...
namespace VolMagick
{
				  ...
				  uint64 off_x, uint64 off_y, uint64 off_z) const
  {
	...
	readVolumeFile(vol,filename,0,0,0,0,0,volinfo.dimension(),Dimension(256,256,256));
      }
    catch(ReadError &e)
      {
	createVolumeFile(filename,
			 ...
			 0,0,0.0,0.0);
	readVolumeFile(vol,filename,0,0,0,0,0,wvol.dimension(),Dimension(256,256,256));
      }
