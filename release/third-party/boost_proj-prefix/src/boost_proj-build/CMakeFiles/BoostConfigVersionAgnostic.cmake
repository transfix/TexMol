...
file(GLOB AVAILABLE_VERSIONFILES 
  RELATIVE ${CWD} 
  "/workspace/cvcsoft/TexMol/release/share/boost-*/cmake/BoostConfig.cmake")

message("globbed: ${AVAILABLE_VERSIONFILES}")
if (EXISTS "/workspace/cvcsoft/TexMol/release/share/boost-${PACKAGE_FIND_VERSION_MAJOR}.${PACKAGE_FIND_VERSION_MINOR}.${PACKAGE_FIND_VERSION_PATCH}/cmake/BoostConfig.cmake")
  #
  #  Exact version
  #
