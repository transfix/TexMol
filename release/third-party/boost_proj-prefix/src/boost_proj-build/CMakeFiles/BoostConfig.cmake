...
set(Boost_INCLUDE_DIRS "/workspace/cvcsoft/TexMol/release/include")
set(Boost_INCLUDE_DIR "/workspace/cvcsoft/TexMol/release/include"
  CACHE FILEPATH "Boost include directory")
set(Boost_LIBRARY_DIRS "/workspace/cvcsoft/TexMol/release/lib")
#
#  Include the imported targets
#
include("/workspace/cvcsoft/TexMol/release/lib/Boost.cmake")
...
if (NOT Boost_FIND_COMPONENTS)
  set(Boost_FIND_COMPONENTS "wave;signals;program_options;iostreams;filesystem;unit_test_framework;system;graph;wserialization;regex;thread;date_time")
endif()
