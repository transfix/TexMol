...
// Returns the logger for the current function
// Logger getLogger();
// Returns the logger with the given signature
Logger getLogger(const std::string& str);
// Logger getFuncLogger(const std::string suffix = "");
std::string toJavaStyle(const std::string& function);
// Returns the logger at [current function].str
// Logger getSubLogger(const std::string& str);
// End added by jme
...
// Added by jme 7/19/2012
#define FUNCTION_LOGGER log4cplus::getLogger(log4cplus::toJavaStyle(BOOST_CURRENT_FUNCTION))
#define SUB_FUNCTION_LOGGER(x) log4cplus::getLogger(log4cplus::toJavaStyle(BOOST_CURRENT_FUNCTION)+"."+x)
// End added by jme
