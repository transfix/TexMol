...
public:
    ...
    {
        FileSaveDialogBase->setWindowTitle(QCoreApplication::translate("FileSaveDialogBase", "Save image"));
        buttonHelp->setText(QCoreApplication::translate("FileSaveDialogBase", "&Help"));
        buttonHelp->setShortcut(QCoreApplication::translate("FileSaveDialogBase", "F1"));
        buttonOk->setText(QCoreApplication::translate("FileSaveDialogBase", "&OK"));
        buttonOk->setShortcut(QString());
        buttonCancel->setText(QCoreApplication::translate("FileSaveDialogBase", "&Cancel"));
        buttonCancel->setShortcut(QString());
        m_FileNamePushButton->setText(QCoreApplication::translate("FileSaveDialogBase", "File name"));
        m_FileFormatTextLabel->setText(QCoreApplication::translate("FileSaveDialogBase", "File type"));
        m_SaveAllCheckBox->setText(QCoreApplication::translate("FileSaveDialogBase", "Save all split views"));
...
public:
    FileSaveDialogBase(QWidget* parent = 0, const char* name = 0, bool modal = false, Qt::WindowFlags fl = {}) : QDialog(parent, fl) { setupUi(this); if(name) setObjectName(name); setModal(modal); }
    ~FileSaveDialogBase() {}
