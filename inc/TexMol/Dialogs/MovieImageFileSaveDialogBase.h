...
public:
    ...
    {
        MovieImageFileSaveDialogBase->setWindowTitle(QCoreApplication::translate("MovieImageFileSaveDialogBase", "Movie images information"));
        buttonHelp->setText(QCoreApplication::translate("MovieImageFileSaveDialogBase", "&Help"));
        buttonHelp->setShortcut(QCoreApplication::translate("MovieImageFileSaveDialogBase", "F1"));
        buttonOk->setText(QCoreApplication::translate("MovieImageFileSaveDialogBase", "&OK"));
        buttonOk->setShortcut(QString());
        buttonCancel->setText(QCoreApplication::translate("MovieImageFileSaveDialogBase", "&Cancel"));
        buttonCancel->setShortcut(QString());
        m_AnimationFileNamePushButton->setText(QCoreApplication::translate("MovieImageFileSaveDialogBase", "Animation file"));
        m_BaseImageFileNamePushButton->setText(QCoreApplication::translate("MovieImageFileSaveDialogBase", "Base image file"));
        m_ImageFileFormatsTextLabel->setText(QCoreApplication::translate("MovieImageFileSaveDialogBase", "Image formats"));
...
public:
    MovieImageFileSaveDialogBase(QWidget* parent = 0, const char* name = 0, bool modal = false, Qt::WindowFlags fl = {}) : QDialog(parent, fl) { setupUi(this); if(name) setObjectName(name); setModal(modal); }
