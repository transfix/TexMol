...
public:
    ...
    void setupUi(QDialog *ScriptsDialogBase)
    {
        ...
        m_CommandsTextEdit = new QTextEdit(ScriptsDialogBase);
    ...
    {
        ScriptsDialogBase->setWindowTitle(QCoreApplication::translate("ScriptsDialogBase", "Scripts"));
        buttonHelp->setText(QCoreApplication::translate("ScriptsDialogBase", "&Help"));
        buttonHelp->setShortcut(QCoreApplication::translate("ScriptsDialogBase", "F1"));
        buttonOk->setText(QCoreApplication::translate("ScriptsDialogBase", "&OK"));
        buttonOk->setShortcut(QString());
        buttonCancel->setText(QCoreApplication::translate("ScriptsDialogBase", "&Cancel"));
        buttonCancel->setShortcut(QString());
        m_LoadPushButton->setText(QCoreApplication::translate("ScriptsDialogBase", "Load"));
        m_SavePushButton->setText(QCoreApplication::translate("ScriptsDialogBase", "Save"));
        m_ExecutePushButton->setText(QCoreApplication::translate("ScriptsDialogBase", "Execute"));
...
public:
    ScriptsDialogBase(QWidget* parent = 0, const char* name = 0, bool modal = false, Qt::WindowFlags fl = {}) : QDialog(parent, fl) { setupUi(this); if(name) setObjectName(name); setModal(modal); }
    ~ScriptsDialogBase() {}
