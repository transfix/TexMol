...
public:
    ...
    QGroupBox *m_CurrentTransformationsGroupBox;
    QGridLayout *gridLayout1;
    QListWidget *m_CurrentTransformationsListBox;
    QGroupBox *m_NewTransformationsGroupBox;
    ...
    QGroupBox *m_GeneralRotationGroupBox;
    ...
    QGroupBox *m_GeneralTransformationGroupBox;
    ...
    void setupUi(QDialog *TransformationsDialogBase)
    {
        ...
        m_CurrentTransformationsGroupBox = new QGroupBox(TransformationsDialogBase);
        m_CurrentTransformationsGroupBox->setObjectName(QString::fromUtf8("m_CurrentTransformationsGroupBox"));
            QVBoxLayout *_vbl1 = new QVBoxLayout(m_CurrentTransformationsGroupBox);
        ...
        m_CurrentTransformationsListBox = new QListWidget(m_CurrentTransformationsGroupBox);
        ...
        m_NewTransformationsGroupBox = new QGroupBox(TransformationsDialogBase);
        m_NewTransformationsGroupBox->setObjectName(QString::fromUtf8("m_NewTransformationsGroupBox"));
            QVBoxLayout *_vbl2 = new QVBoxLayout(m_NewTransformationsGroupBox);
        ...
        m_GeneralRotationGroupBox = new QGroupBox(m_NewTransformationsGroupBox);
        m_GeneralRotationGroupBox->setObjectName(QString::fromUtf8("m_GeneralRotationGroupBox"));
            QVBoxLayout *_vbl3 = new QVBoxLayout(m_GeneralRotationGroupBox);
        ...
        m_GeneralTransformationGroupBox = new QGroupBox(m_NewTransformationsGroupBox);
        m_GeneralTransformationGroupBox->setObjectName(QString::fromUtf8("m_GeneralTransformationGroupBox"));
            QVBoxLayout *_vbl4 = new QVBoxLayout(m_GeneralTransformationGroupBox);
    ...
    {
        TransformationsDialogBase->setWindowTitle(QCoreApplication::translate("TransformationsDialogBase", "Objects transformations"));
        buttonHelp->setText(QCoreApplication::translate("TransformationsDialogBase", "&Help"));
        buttonHelp->setShortcut(QCoreApplication::translate("TransformationsDialogBase", "F1"));
        buttonOk->setText(QCoreApplication::translate("TransformationsDialogBase", "&OK"));
        buttonOk->setShortcut(QString());
        buttonCancel->setText(QCoreApplication::translate("TransformationsDialogBase", "&Cancel"));
        buttonCancel->setShortcut(QString());
        m_CurrentTransformationsGroupBox->setTitle(QCoreApplication::translate("TransformationsDialogBase", "Current transformations"));
        m_CurrentTransformationsListBox->clear();
        m_CurrentTransformationsListBox->addItem(QCoreApplication::translate("TransformationsDialogBase", "New Item"));
        m_NewTransformationsGroupBox->setTitle(QCoreApplication::translate("TransformationsDialogBase", "Add new transformation"));
        m_AddTranslationPushButton->setText(QCoreApplication::translate("TransformationsDialogBase", "Add translation"));
        m_AddRotationPushButton->setText(QCoreApplication::translate("TransformationsDialogBase", "Add rotation"));
        m_AddScalePushButton->setText(QCoreApplication::translate("TransformationsDialogBase", "Add scale"));
        m_GeneralRotationGroupBox->setTitle(QString());
        m_GeneralRotationPushButton->setText(QCoreApplication::translate("TransformationsDialogBase", "General Rotation"));
        m_GeneralTransformationGroupBox->setTitle(QString());
        m_GeneralTransformationPushButton->setText(QCoreApplication::translate("TransformationsDialogBase", "General Xform"));
...
public:
    TransformationsDialogBase(QWidget* parent = 0, const char* name = 0, bool modal = false, Qt::WindowFlags fl = {}) : QDialog(parent, fl) { setupUi(this); if(name) setObjectName(name); setModal(modal); }
