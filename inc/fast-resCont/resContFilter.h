...
class resContFilter
{
 ...
 public:
   ...
   void getScores( Matrix transMat, vector<Point> &staticAtoms, vector<Point> &movingAtoms, vector<double> &staticAtomValues, vector<double> &movingAtomValues, double &val);
   void getScores( vector<Point> &staticAtoms, vector<Point> &movingAtoms, vector<double> &staticAtomValues, vector<double> &movingAtomValues, double &val);
