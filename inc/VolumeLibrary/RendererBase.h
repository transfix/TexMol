...
#include <VolumeLibrary/Extent.h>
...
namespace OpenGLVolumeRendering
{
	class RendererBase
	{
		public:
			...
			/* Get triangles (transparent render needs to sort these along with other renderered
			 * triangles before drawing) */
			Geometry* getGeometry();
			virtual void prepareToRenderGeometry();
		protected:
			// data
