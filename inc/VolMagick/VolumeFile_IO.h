...
/* $Id: VolumeFile_IO.h 6010 2012-09-11 20:31:35Z edwardsj $ */
  ...
  struct VolumeFile_IO
  {
    ...
    virtual void readVolumeFile(Volume& /*vol*/, 
				...
				const Dimension& /*subvoldim*/,
                                const Dimension& maxdim = Dimension(256,256,256)) const = 0;
    ...
    virtual void readVolumeFile(Volume& vol, 
				...
				const BoundingBox& subvolbox,
                                const Dimension& maxdim = Dimension(256,256,256)) const;
