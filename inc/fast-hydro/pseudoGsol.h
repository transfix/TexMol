...
#include <fast-hydro/ElementInformation.h>
#include <DPG/PG.h>
...
class pseudoGsol
{
 private:
	...
	int *staticQPointsIndex;
	int *movingQPointsIndex;
...
//    float getHydrophobicity( char *atomName, char *residueName );
    ...
    void countQPointsOctreeNodesAndSortQPoints( QPOINT *qPts, int *qPtsIndex, int qPtsStartID, int qPtsEndID, 
    ...
    bool buildQPointsOctree( int nQPoints, QPOINT *qPoints, int *qPointsIndex, int *numQPointsOctreeNodes, QPOINTS_OCTREE_NODE **qPointsOctree, int *qPointsOctreeRoot );
 ...
 public: 
    ...
    void getScores( double *trans, double *transI, vector<double> &staticQuadValues, vector<double> &staticQuadWeights,  vector<double> &movingQuadValues, vector<double> &movingQuadWeights, double & val);
    void getScores(vector<double> &staticQuadValues, vector<double> &staticQuadWeights, vector<double> &movingQuadValues, vector<double> &movingQuadWeights, double & val);
