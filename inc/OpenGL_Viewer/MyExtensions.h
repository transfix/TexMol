...
#include <OpenGL_Viewer/ExtensionPointers.h>

#ifdef DECLARE_STATIC_POINTERS
#include <OpenGL_Viewer/StaticExtensionPointers.h>
...
class MyExtensions
{
	public:
		...
		bool extensionExists(const char *extension);
		...
		// GL_EXT_framebuffer_object
        	MYPFNGLGENFRAMEBUFFERSEXTPROC glGenFramebuffersEXT;
        	MYPFNGLDELETEFRAMEBUFFERSEXTPROC glDeleteFramebuffersEXT;
        	MYPFNGLBINDFRAMEBUFFEREXTPROC glBindFramebufferEXT;
        	MYPFNGLCHECKFRAMEBUFFERSTATUSEXTPROC glCheckFramebufferStatusEXT;
        	MYPFNGLGETFRAMEBUFFERATTACHMENTPARAMETERIVEXTPROC glGetFramebufferAttachmentParameterivEXT;
        	MYPFNGLGENERATEMIPMAPEXTPROC glGenerateMipmapEXT;
        	MYPFNGLFRAMEBUFFERTEXTURE2DEXTPROC glFramebufferTexture2DEXT;
       		MYPFNGLFRAMEBUFFERRENDERBUFFEREXTPROC glFramebufferRenderbufferEXT;
        	MYPFNGLGENRENDERBUFFERSEXTPROC glGenRenderbuffersEXT;
        	MYPFNGLDELETERENDERBUFFERSEXTPROC glDeleteRenderbuffersEXT;
        	MYPFNGLBINDRENDERBUFFEREXTPROC glBindRenderbufferEXT;
        	MYPFNGLRENDERBUFFERSTORAGEEXTPROC glRenderbufferStorageEXT;
        	MYPFNGLGETRENDERBUFFERPARAMETERIVEXTPROC glGetRenderbufferParameterivEXT;
        	MYPFNGLISRENDERBUFFEREXTPROC glIsRenderbufferEXT;
