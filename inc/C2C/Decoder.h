...
class Decoder
{
	...
	protected:
		int InterpEdge(ContourGeom* con, T* val, u_char* color, T grad[3][8], int i, int j, int edge);
		void interpRect3Dpts_x(int i1, int j1, int k1, T* data, u_char* color, T grad[3][8], int d1, int d2, float pt[3], float norm[3], float clr[3]);
		void interpRect3Dpts_y(int i1, int j1, int k1, T* data, u_char* color, T grad[3][8], int d1, int d2, float pt[3], float norm[3], float clr[3]);
		void interpRect3Dpts_z(int i1, int j1, int k1, T* data, u_char* color, T grad[3][8], int d1, int d2, float pt[3], float norm[3], float clr[3]);
