...
inline void CCVContouring::SingleExtractor::getNormal(unsigned char* data,
...
inline void CCVContouring::SingleExtractor::buildEdgeCacheOffsetTable(unsigned int* table, unsigned int width) const
{
...
inline void CCVContouring::SingleExtractor::isCached(bool* cachedTable, unsigned int i, unsigned int j, unsigned int k, unsigned int width, unsigned int height) const
{
	// bool ret = false;
	// ret = j!=0 || k!=0;
	// edge 0
...
inline void CCVContouring::SingleExtractor::buildOffsetTable(unsigned int* table, unsigned int width, unsigned int height) const
{
...
inline void CCVContouring::SingleExtractor::buildWithinSliceOffsetTable(unsigned int* table, unsigned int width) const
{
	// determine the offset of each vertex of the cube give the width and height of the data
	unsigned int c;
	for(c=0; c<8; c++)
...
inline void CCVContouring::SingleExtractor::computeVertFromOffset(GLfloat& vx, GLfloat& vy, GLfloat& vz, unsigned int offset, unsigned int width, unsigned int height) const
{
